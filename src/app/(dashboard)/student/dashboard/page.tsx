        ...
        <Card className="glass-card">
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              ...
              <div className={`h-12 w-12 rounded-full flex items-center justify-center ${attendancePercentage >= 75 ? "bg-green-500/10" : "bg-red-500/10"
                }`}>
                <Calendar className={`h-6 w-6 ${attendancePercentage >= 75 ? "text-green-500" : "text-red-500"
                  }`} />
              </div>
            </div>
          </CardContent>
